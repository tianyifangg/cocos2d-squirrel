...
# This script is used to generate squirrel-binding glue codes.
...
def main():
    ...
    try:
        ...
        squirrel_root = '%s/tools/squirrel' % project_root
        output_dir = '%s/cocos/scripting/squirrel-bindings/auto' % project_root

        cmd_args = {'cocos2dx.ini' : ('cocos2d-x', 'squirrel_cocos2dx_auto'), \
                    }
        ...
        print '---------------------------------'
        print 'Generating squirrel bindings succeeds.'
        print '---------------------------------'

    except Exception as e:
        if e.__class__.__name__ == 'CmdError':
            print '---------------------------------'
            print 'Generating squirrel bindings fails.'
            print '---------------------------------'
            sys.exit(1)
        else:
            raise
