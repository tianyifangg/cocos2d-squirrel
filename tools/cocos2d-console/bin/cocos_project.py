...
class Project(object):
    ...
    @staticmethod
    def language_list():
        return (Project.CPP, Project.LUA, Project.JS, Project.SQ)
    ...
    def _is_script_project(self):
        return self._is_lua_project() or self._is_js_project() or self._is_sq_project()
    ...
    def _is_sq_project(self):
        return self._project_lang == Project.SQ
