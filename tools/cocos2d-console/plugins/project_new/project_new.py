...
class CCPluginNew(cocos.CCPlugin):
    ...
    DEFAULT_PROJ_NAME = {
        ...
        cocos_project.Project.SQ: 'MySquirrelGame'
    }
    ...
    def parse_args(self, argv):
        ...
        parser.add_argument("-l", "--language",
                            required=True,
                            choices=["cpp", "lua", "js", "sq"],
                            help="Major programming language you want to use, should be [cpp | lua | js | sq]")
    ...
    def _create_from_cmd(self):
        ...
        if self._lang in (cocos_project.Project.LUA, cocos_project.Project.JS, cocos_project.Project.SQ):
...
# cmd methods below
    ...
    def append_x_engine(self, v):
        ...
        if self.lang == 'lua':
            ...
            fileList = fileList + data['squirrel']
