...
--------------------------------------------------------
-- the cc Mat4
-- @field [parent=#cc] Mat4#Mat4 Mat4 preloaded module
...
--------------------------------------------------------
-- the cc AffineTransform
-- @field [parent=#cc] AffineTransform#AffineTransform AffineTransform preloaded module
...
--------------------------------------------------------
-- the cc PhysicsMaterial
-- @field [parent=#cc] PhysicsMaterial#PhysicsMaterial PhysicsMaterial preloaded module
...
--------------------------------------------------------
-- the cc Quaternion
-- @field [parent=#cc] Quaternion#Quaternion Quaternion preloaded module
...
--------------------------------------------------------
-- the cc BlendFunc
-- @field [parent=#cc] BlendFunc#BlendFunc BlendFunc preloaded module
